...
var colors14__default = /*#__PURE__*/_interopDefault(colors14);
var axios__default = /*#__PURE__*/_interopDefault(axios);
var z4__namespace = /*#__PURE__*/_interopNamespace(z4);
var Spinnies__default = /*#__PURE__*/_interopDefault(Spinnies);
...
function help() {
  return Promise.resolve(
    colors14__default.default.bold.white(`
\u2715\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2715
...
// core/base/agent.ts
var spinnies = new Spinnies__default.default();
async function Engine({
  query
}) {
  let videoId, TubeCore, TubeBody;
  const metaSpin = crypto.randomUUID();
  spinnies.add(metaSpin, {
    text: (/* @__PURE__ */ new Date()).toLocaleString() + " " + colors14__default.default.bold.blue("INFO: ") + colors14__default.default.reset("")
  });
  spinnies.update(metaSpin, {
    text: (/* @__PURE__ */ new Date()).toLocaleString() + " " + colors14__default.default.bold.blue("INFO: ") + "\u2B55 using yt-core version <(" + version + ")>" + colors14__default.default.reset("")
  });
  if (!query || query.trim() === "") {
    spinnies.fail(metaSpin, {
      text: (/* @__PURE__ */ new Date()).toLocaleString() + " " + colors14__default.default.bold.red("ERROR: ") + "\u274C 'query' is required..." + colors14__default.default.reset("")
    });
    return;
  }
  if (/https/i.test(query) && /list/i.test(query)) {
    spinnies.fail(metaSpin, {
      text: (/* @__PURE__ */ new Date()).toLocaleString() + " " + colors14__default.default.bold.red("ERROR: ") + "\u274C use extract_playlist_videos() for playlists..." + colors14__default.default.reset("")
    });
    return;
  }
  if (/https/i.test(query) && !/list/i.test(query)) {
    spinnies.update(metaSpin, {
      text: (/* @__PURE__ */ new Date()).toLocaleString() + " " + colors14__default.default.bold.blue("INFO: ") + "\u2B55 fetching metadata for: <(" + query + ")>" + colors14__default.default.reset("")
    });
  ...
  if (videoId) {
    ...
    if (!TubeBody.stdout.Link) {
      spinnies.fail(metaSpin, {
        text: (/* @__PURE__ */ new Date()).toLocaleString() + " " + colors14__default.default.bold.red("ERROR: ") + "\u274C no data returned from server..." + colors14__default.default.reset("")
      });
      return;
    } else {
      spinnies.update(metaSpin, {
        text: (/* @__PURE__ */ new Date()).toLocaleString() + " " + colors14__default.default.bold.blue("INFO: ") + "\u{1F4E1} preparing payload for <(" + TubeBody.stdout.Title + "Author:" + TubeBody.stdout.Uploader + ")>" + colors14__default.default.reset("")
      });
  ...
  if (TubeCore === null) {
    spinnies.fail(metaSpin, {
      text: (/* @__PURE__ */ new Date()).toLocaleString() + " " + colors14__default.default.bold.red("ERROR: ") + "\u274C please try again later..." + colors14__default.default.reset("")
    });
    return;
  }
  spinnies.succeed(metaSpin, {
    text: (/* @__PURE__ */ new Date()).toLocaleString() + " " + colors14__default.default.bold.blue("INFO: ") + "\u2763\uFE0F Thank you for using yt-core! If you enjoy the project, consider Staring the GitHub repo https://github.com/shovitdutta/mixly/yt-core." + colors14__default.default.reset("")
  });
...
async function get_playlist({
  ...
  try {
    ...
    for (const url of playlistUrls) {
      ...
      if (!ispUrl) {
        console.error(
          colors14__default.default.bold.red("ERROR: "),
          "Invalid YouTube Playlist URL:",
          url
        );
        continue;
      }
      const resp = await search2__default.default({ listId: ispUrl[1] });
      if (!resp) {
        console.error(
          colors14__default.default.bold.red("ERROR: "),
      ...
      for (let i = 0; i < resp.videos.length; i++) {
        try {
          ...
          const metaTube = await search2__default.default({ videoId });
          console.log(
            colors14__default.default.bold.green("INFO:"),
            colors14__default.default.bold.green("<("),
            metaTube.title,
            colors14__default.default.bold.green("by"),
          ...
          console.error(colors14__default.default.bold.red("ERROR: "), error);
        }
      }
    }
    return proTubeArr;
  } catch (error) {
    return error instanceof z4__namespace.ZodError ? error.errors : error;
  }
}
...
var progressBar = (percent) => {
  ...
  const completedStr = colors14__default.default.bold.bgGreen(" ".repeat(completed));
  const incompleteStr = colors14__default.default.bold.gray(" ".repeat(incomplete));
  const percentStr = colors14__default.default.bold.blue(" " + percent.toFixed(2) + "% ");
  const progressBarString = (/* @__PURE__ */ new Date()).toLocaleString() + colors14__default.default.bold.blue(" INFO:") + " " + completedStr + incompleteStr + percentStr;
...
async function AudioLowest({
  ...
  try {
    ...
    ytc.on("start", (cmd) => {
      if (verbose)
        console.log(cmd);
      progressBar_default(0);
    });
    ytc.on("end", () => progressBar_default(100));
    ytc.on("close", () => progressBar_default(100));
    ytc.on("progress", ({ percent }) => progressBar_default(percent));
    ytc.on("error", (error) => {
      return error;
    });
    switch (filter2) {
...
async function AudioQualityCustom({
  ...
  try {
    ...
    ytc.on("start", () => progressBar_default(0));
    ytc.on("end", () => progressBar_default(100));
    ytc.on("close", () => progressBar_default(100));
    ytc.on("progress", ({ percent }) => progressBar_default(percent));
    ytc.on("error", (error) => {
    ...
    if (stream$1) {
      ...
      return {
        stream: readStream,
        filename: folderName ? path__namespace.join(metaFold, `yt-core-(${quality})-${title}.${outputFormat}`) : `yt-core-(${quality})-${title}.${outputFormat}`
      };
    } else {
      await new Promise((resolve, reject2) => {
        ytc.output(
...
async function VideoQualityCustom({
  ...
  try {
    ...
    if (!YSBody) {
      ...
      const opfol = folderName ? path__namespace.join(process.cwd(), folderName) : process.cwd();
      ...
      if (stream$1) {
        ...
        await new Promise((resolve, reject2) => {
          ytc.output(path__namespace.join(opfol, ipop)).on("error", reject2).on("end", () => {
            resolve();
          }).run();
        });
        return {
      ...
      await index.eachSeries(
        ...
        async (video) => {
          try {
            ...
            results.push({
              status: 500,
              message: colors14__default.default.bold.red("ERROR: ") + video.title
            });
          }
        }
      );
...
var program = async () => {
  ...
  switch (command) {
    case "version":
    case "v":
      console.error(colors14__default.default.green("Installed Version: yt-core@" + version));
      break;
    case "help":
    case "h":
      core_default.info.help().then((data) => {
        ...
        console.error(colors14__default.default.red(error));
        process.exit();
      });
      break;
    case "extract":
    case "e":
      if (!proTube || !proTube.query || proTube.query.length === 0) {
        console.error(colors14__default.default.red("error: no query"));
      } else
    ...
    case "aqc":
      ...
      if (!proTube || !proTube.format || proTube.format.length === 0) {
        console.error(colors14__default.default.red("error: no format"));
      }
